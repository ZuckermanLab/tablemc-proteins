...
private:
    ...
    void moved_energy(bool * moved, bool * movedatoms, double * center, double * orient, double * coords, double * energies, double * etot);
    void total_energy(double * center, double * orient, double * coords, double * energies, double * etot);
