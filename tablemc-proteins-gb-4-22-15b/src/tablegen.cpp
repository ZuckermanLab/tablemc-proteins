...
double table::get_pair_energy(forcefield * ffield, fragmenttype * frag1, fragmenttype * frag2, double * coords1, double * coords2,
    double r, double sphtheta, double sphphi, double phi, double theta, double psi)
{
    double x[3],q[4];
                        sph_to_cart(r,sphtheta,sphphi,&x[0]);
    ...
    return ffield->exact_interaction_energy(false,0.0,0.0,hdr.eps,frag1->natom,frag1->types,coords1,frag2->natom,frag2->types,coords2);
}
