...
#define EN_GB_POLAR       8
#define EN_SASA           9
#define EN_TERMS          10 //adjust this if more terms are added!
...
public:
    ...
    void moved_non_tabulated_energy(double eps, int rdie, int numOfAtoms, ATOMS * atoms, bool * movedatoms, int nb_atom_list_size, atom_nb_entry * nb_atom_list,  double * coords, double * energies);
    void non_tabulated_energy(double eps, int rdie, int numOfAtoms, ATOMS * atoms, int full_atom_list_count, atom_nb_entry * non_tab_list, double * coords, double * energies);
