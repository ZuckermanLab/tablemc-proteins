...
private:
    ...
    int use_std_tables, use_cov_tables, pbc, interp, enwrite; //, rdie;
    gb_param_info gb_params;
    ...
    double * neworient;
    double * newcoords;
    double * new_per_frag_born_radii;
    double * oldcenter;
    double * oldorient;
    double * oldcoords;
    double * old_per_frag_born_radii;
    /*other data*/
    ...
    void moved_energy(bool * moved, bool * movedatoms, double * center, double * orient, double * coords, double * per_frag_born_radii, double * energies, double * etot);
    void total_energy(double * center, double * orient, double * coords, double * per_frag_born_radii, double * energies, double * etot);
