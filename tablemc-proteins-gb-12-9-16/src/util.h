...
#define TIMER_BORN_RADII     6
#define TIMER_GB_POLAR       7
#define TIMER_GB_SASA        8
#define TIMER_COV_TABLES     9
...
static const char * timer_names[NTIMERS] = {"MC moves","Bonds","Angles","Dihedrals","Impropers","Non tab. VDW/Elec","Born radii","GB Polar","SASA","Backbone tables","Check cutoff",
